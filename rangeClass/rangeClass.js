...
Range.prototype.each = function (callback) {
  ...
  // }
  //console.log(start); console.log(end); console.log(step);
...
// var evenNumbers = new Range();

// //var evenNumbers = new Range(0,10); // a new range representing the numbers between 0 and 10 (inclusively)*
// // var evenNumbers = new Range(2,8,2); // A range with the even numbers 2, 4, 6, and 8.
//   evenNumbers.each(function(val){
//    console.log(val+"!");
//  });
